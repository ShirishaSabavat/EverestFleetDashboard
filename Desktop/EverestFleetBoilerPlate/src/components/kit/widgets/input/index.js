...
const InputWrapper = forwardRef(({
  ...
  return (
    ...
    >
      ...
      {/* LABEL */}
      {label && (
        <div style={{ fontFamily: 'montserrat' }} className="space-x-2 text-xs text-eep-gray font-semi-bold">
          <span>{label}</span>
      ...
      {/* LIMIT */}
      {limit && (
        <Space style={{ fontFamily: 'montserrat' }} className="font-semi-bold flex justify-end text-xs text-eep-gray">
