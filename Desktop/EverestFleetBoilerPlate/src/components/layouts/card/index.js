...
const Card = ({
  ...
  <div
    className={`bg-gray-50 font-semi-bold w-full space-y-1 shadow-1 ${className || ''}`}
    style={style}
  >
    {/* HEADER */}
    <div style={{ fontFamily: 'montserrat' }} className={`bg-white p-6 rounded-t-lg ${Icon ? 'flex space-x-3 items-center' : ''}`}>
