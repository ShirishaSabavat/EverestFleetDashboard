...
const Hisaab = ({
  ...
  useEffect(async () => {
    ...
    hisaabPromises.push(await onFetchHisaabDataApi(driverETM, calenderDate));
    hisaabPromises.push(await onFetchDriverWeeklyDataApi(driverETM));
